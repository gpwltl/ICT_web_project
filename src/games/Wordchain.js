  ...
  render() {
    ...
    return (
      <>
        ...
        <form onSubmit={this.onSubmitForm} className="input_w">
          <input
            //ref={this.onRefInput}
        ...
        <div className="result-correct_w">{this.state.correct}</div>
        <div className="result-wrong_w">{this.state.wrong}</div>
      </>
    );
  }
}
